...
This subsection shows an scenario where a Trusted Component Developer generates
a SUIT manifest which unlinks the Trusted Component installed in the TEEP Device.
The TAM delivers it when the TAM wants to uninstall the component.
